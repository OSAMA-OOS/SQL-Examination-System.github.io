...
BEGIN
    ...
    SET @SQLG = 'GRANT INSERT, UPDATE, DELETE ON [Members].[Student_Answer] TO ' + QUOTENAME(@UserName);
    ...
    SET @GrantPermission = 'GRANT INSERT, UPDATE, DELETE ON [Members].[Student_Answer] TO ' + QUOTENAME(SUSER_SNAME());
