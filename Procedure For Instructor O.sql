...
exec insert_Question 1,10,22,1,1
...
begin 
	...
	begin
		THROW 51000, 'Student already exist or You Cannot add students in this exam now ', 1;
		rollback
	end
end
...
---------------------------------------------- Adding Students of specific Course in specific track --------------------------
  ...
  begin 
   ...
   exec Choose_Students_for_Exam_in_Course 1,1,18,'01:00:00','03:00:00'
